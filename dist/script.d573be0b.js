...
$(document).ready(function () {
  ...
  $("#btn, #nav1").on("click", function () {
    ...
    gsap.to("#v_1, #jimin_1, #jungkook_1, #sugar_1, #jhope_1, #jin_1, #rm_1", {
      opacity: 0,
      ease: "Power3.easeOut",
      duration: 2,
      delay: .1
  ...
  $("#nav2").on("click", function () {
    ...
    gsap.to("#dynamite1 span", {
      opacity: 0,
      ease: "Power3.easeOut",
      duration: 1,
      delay: .1
    });
    gsap.to("#dynamite2 span", {
      opacity: 0,
      ease: "Power3.easeOut",
      duration: 1,
      delay: .1
    });
    gsap.to("#dynamite3 span", {
      opacity: 0,
      ease: "Power3.easeOut",
      duration: 1,
      delay: .1
  ...
  var rolling = gsap.to("#albumbox", {
    rotation: "360deg",
    ease: "none",
    duration: 2,
    repeat: -1
  });
  var movelp = gsap.to("#lp", {
    left: "17vw",
    ease: "Power3.easeOut",
    duration: 1
  });
  rolling.pause();
  movelp.pause(); //playlist
...
},{}]},{},["C:/Users/namhy/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script.js"], null)
